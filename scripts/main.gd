...
func _create_board_node() -> void:
	...
	_board_material.set_shader_parameter("wall_tilt", 0.55)
	_board_material.set_shader_parameter("foam_intensity", 0.55)
	_board_material.set_shader_parameter("shore_shadow", 0.22)
...
func _position_all_nodes() -> void:
	...
	if _board_material:
		...
		_board_material.set_shader_parameter("foam_width_px", cs * 0.35)
